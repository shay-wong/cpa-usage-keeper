  ...
  en: {
    translation: {
      ...
      usage_stats: {
        ...
        request_events_detail_cached_no: 'Live detail',
        request_events_detail_fetched_at: 'Fetched At',
        request_events_detail_attempt_title: 'Attempt {{index}} / {{total}}',
        request_events_detail_waiting_upstream:
          'Waiting for upstream request log to become available...',
        request_events_detail_load_failed:
          'Unable to load request detail. Please try again later.',
        request_events_detail_missing:
          'Request detail is unavailable. Recording may be disabled or the request has no detail ID.',
        request_events_detail_upstream_pending:
          'The upstream request log is not ready yet. Try again shortly.',
        ...
        credentials_quota_billing_usage_aria:
          'Spend: {{used}} / {{limit}}, Remaining: {{remaining}}',
        ...
        analysis_token_usage_subtitle:
          'Input, output, cached and reasoning tokens with request and cost trends.',
        analysis_cost_breakdown_title: 'Cost Breakdown',
        analysis_cost_breakdown_subtitle:
          'Input, output and cached spend calculated from current model pricing.',
        ...
        analysis_model_efficiency_subtitle:
          'Cost per 1M total tokens by model.',
        analysis_composition_title: 'Usage Distribution',
        analysis_composition_subtitle:
          'Switch dimensions to compare token share, spend and request volume.',
        ...
        analysis_heatmap_subtitle:
          'Token distribution across API keys and models with hover details.',
  ...
  zh: {
    translation: {
      ...
      usage_stats: {
        ...
        request_events_detail_cached_no: '即时详情',
        request_events_detail_fetched_at: '拉取时间',
        request_events_detail_attempt_title: '第 {{index}} / {{total}} 次尝试',
        request_events_detail_waiting_upstream: '正在等待上游请求日志返回...',
        request_events_detail_load_failed: '请求详情加载失败，请稍后重试。',
        request_events_detail_missing: '请求详情不可用，可能未开启记录或该请求没有详情 ID。',
        request_events_detail_upstream_pending: '上游请求日志还没准备好，稍后重试。',
        ...
        analysis_token_usage_subtitle:
          '按时间展示输入、输出、缓存、推理 Token，并叠加请求和花费趋势。',
  ...
  'zh-TW': {
    translation: {
      ...
      usage_stats: {
        ...
        request_events_detail_cached_no: '即時詳情',
        request_events_detail_fetched_at: '拉取時間',
        request_events_detail_attempt_title: '第 {{index}} / {{total}} 次嘗試',
        request_events_detail_waiting_upstream: '正在等待上游請求記錄返回...',
        request_events_detail_load_failed: '請求詳情載入失敗，請稍後再試。',
        request_events_detail_missing: '請求詳情不可用，可能未開啟記錄或該請求沒有詳情 ID。',
        request_events_detail_upstream_pending: '上游請求記錄尚未準備好，請稍後再試。',
        ...
        analysis_token_usage_subtitle:
          '按時間顯示輸入、輸出、快取、推理 Token，並疊加請求和花費趨勢。',
        analysis_cost_breakdown_title: '成本拆分',
