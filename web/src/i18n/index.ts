  ...
  en: {
    translation: {
      ...
      usage_stats: {
        ...
        database_cleanup_max_size_mb: 'Maximum database size',
        database_cleanup_disabled_hint: '0 disables cleanup',
        database_cleanup_size_hint: '0 disables size-based cleanup; checked during daily maintenance.',
  ...
  zh: {
    translation: {
      ...
      usage_stats: {
        ...
        database_cleanup_max_size_mb: '数据库最大占用',
        database_cleanup_disabled_hint: '填 0 表示关闭清理',
        database_cleanup_size_hint: '填 0 表示关闭按大小清理；每日维护任务检查。',
  ...
  'zh-TW': {
    translation: {
      ...
      usage_stats: {
        ...
        database_cleanup_max_size_mb: '資料庫最大占用',
        database_cleanup_disabled_hint: '填 0 表示關閉清理',
        database_cleanup_size_hint: '填 0 表示關閉按大小清理；每日維護任務檢查。',
