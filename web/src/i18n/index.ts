  ...
  en: {
    translation: {
      ...
      usage_stats: {
        ...
        storage_current_database_size_hint: 'SQLite data file size for the current backend instance.',
        ...
        storage_action_running: 'Running',
  ...
  zh: {
    translation: {
      ...
      usage_stats: {
        ...
        storage_current_database_size_hint: '当前运行实例的 SQLite 数据文件大小。',
  ...
  'zh-TW': {
    translation: {
      ...
      usage_stats: {
        ...
        storage_current_database_size_hint: '目前執行實例的 SQLite 資料檔案大小。',
